...
## DuhzitOS 🟰 Best ❄️ NixOS Configs

DuhzitOS v0.0.1 is a simple way of reproducing my configuration on any NixOS system.
...
> to use DuhzitOS v0.0.1 here!** **ddubs has put a lot of effort into the
...
- The entire idea of DuhzitOS is to make NixOS an approachable space.
...
![DuhzitOS First Install Command](img/first-install-cmd.jpg)
...
![DuhzitOS Install Script Command](img/install-script.jpg)
